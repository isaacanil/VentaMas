...
import type { DiscountContext } from '@/features/cart/types';
...
type DiscountAuthorizationLike = DiscountContext & Partial<DiscountAuthorization>;

type AuthorizationContext = {
  discount?: DiscountAuthorizationLike | null;
};
