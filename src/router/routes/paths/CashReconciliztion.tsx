...
const CashRegisterClosure = lazy(() =>
  import(
    '@/modules/cashReconciliation/pages/CashReconciliation/page/CashRegisterClosure/CashRegisterClosure'
  ).then((module) => ({ default: module.CashRegisterClosure })),
);
const CashRegisterOpening = lazy(() =>
  import(
    '@/modules/cashReconciliation/pages/CashReconciliation/page/CashRegisterOpening/CashRegisterOpening'
  ).then((module) => ({ default: module.CashRegisterOpening })),
);
const CashupInvoicesOverview = lazy(() =>
  import(
    '@/modules/cashReconciliation/pages/CashReconciliation/page/CashupInvoicesOverview/CashupInvoicesOverview'
