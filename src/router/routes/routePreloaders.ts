...
export const routePreloaders: Record<string, RoutePreloader> = {
  ...
  [SALES_TERM.BILLS]: () => import('@/modules/invoice/pages/InvoicesPage/InvoicesPage'),
  [SALES_TERM.PREORDERS]: () => import('@/modules/sales/pages/PreorderSale/PreorderSale'),

  [PURCHASE_TERM.PURCHASES]: () => import('@/modules/orderAndPurchase/pages/OrderAndPurchase/Compra/Purchases'),
  [ORDER_TERM.ORDERS]: () => import('@/modules/orderAndPurchase/pages/OrderAndPurchase/Order/Orders'),
  [PURCHASE_TERM.BACKORDERS]: () => import('@/modules/orderAndPurchase/pages/OrderAndPurchase/BackOrders/BackOrders'),

  [EXPENSES_TERM.EXPENSES_LIST]: () => import('@/modules/expenses/pages/Expenses/ExpensesList/ExpensesList'),
  [EXPENSES_TERM.EXPENSES_CREATE]: () => import('@/modules/expenses/pages/Expenses/ExpensesForm/ExpensesForm'),
