...
export function buildFooter(biz, d) {
  ...
  const totalsBody = [
    [
      'Sub-Total:',
      {
        text: money(subtotalBeforeDiscounts),
        style: 'totalsValue',
        margin: [0, 0],
      },
    ],
    ...
    hasIndividualDisc && [
      'Sub-Total (c/desc.):',
      {
        text: money(subtotalAfterDiscounts),
        style: 'totalsValue',
        margin: [0, 0],
      },
    ],
    [
      'ITBIS:',
      { text: money(totalItbis), style: 'totalsValue', margin: [0, 0] },
    ],
    [
      { text: 'Total Acreditado:', bold: true, margin: [0, 4, 0, 2] },
      {
        text: money(totalFinal),
        style: 'totalsValue',
        bold: true,
        margin: [0, 4, 0, 2],
      },
    ...
    stack: [
      {
        ...
        columns: [
          ...
          {
            width: '*',
            stack: [signatureBlock('Recibido Conforme:', 'NOTA DE CRÉDITO')],
          },
          {
            width: '*',
            margin: [0, 2, 0, 0],
      ...
      ...(d.reason
        ? [{ text: `Motivo: ${d.reason}`, margin: [0, 8, 0, 0] }]
        : []),
