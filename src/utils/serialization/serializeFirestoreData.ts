...
export const serializeFirestoreData = <T extends FirestoreData>(
  ...
  if (isFirestoreTimestampLike(obj)) {
    return DateUtils.convertTimestampToMillis(obj) as SerializedFirestoreData<T>;
  }
  ...
  if (typeof obj === 'object') {
    const serialized: Record<string, FirestoreData> = {};
...
): SerializedFirestoreData<T>[] | T[] | null | undefined => {
