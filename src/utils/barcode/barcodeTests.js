...
const testCases = [
  ...
  {
    code: '746123456789',
    description: 'RD sin dígito verificador (12 dígitos)',
  },
  {
    code: '7461234567891',
    description: 'RD con dígito verificador incorrecto',
  },
  ...
  {
    code: '12345678901',
    description: 'UPC-A sin dígito verificador (11 dígitos)',
  },
  {
    code: '123456789013',
    description: 'UPC-A con dígito verificador incorrecto',
  },
  ...
  {
    code: '1234567890123',
    description: 'Posible GTIN-14 sin dígito (13 dígitos)',
  },
  {
    code: '12345678901234',
    description: 'GTIN-14 con dígito verificador incorrecto',
  },
];
...
export function runBarcodeTests() {
  ...
  testCases.forEach((testCase, index) => {
    ...
    try {
      ...
      console.log(
        `✅ Análisis: ${analysis.type || 'Desconocido'}, Válido: ${analysis.isValid}`,
      );

      // Información resumida
      const info = getBarcodeInfo(testCase.code);
      console.log(
        `📄 Info: ${info.message || info.error || 'Sin información'}`,
      );
      ...
      if (hasCorrections) {
        ...
        suggestions.forEach((suggestion, i) => {
          console.log(
            `   ${i + 1}. ${suggestion.type}: ${suggestion.code} - ${suggestion.description}`,
          );
        });
      }
    } catch (error) {
