...
export const fetchAccountReceivableDetails = (createAsyncThunk as any)(
  ...
  async (
    { arId, businessID }: { arId: string; businessID: string },
...
const accountsReceivableSlice = createSlice({
  ...
  reducers: {
    ...
    setARDetailsModal(
      state: AccountsReceivableState,
      action: PayloadAction<{ isOpen: boolean; arId: string }>,
    ) {
  ...
  extraReducers: (builder: any) => {
    builder
      .addCase(
        fetchAccountReceivableDetails.pending,
        (state: AccountsReceivableState) => {
          state.loading = true;
          state.error = null;
        },
      ...
      .addCase(
        fetchAccountReceivableDetails.fulfilled,
        (state: AccountsReceivableState, action: PayloadAction<any>) => {
          state.loading = false;
      ...
      .addCase(
        fetchAccountReceivableDetails.rejected,
        (state: AccountsReceivableState, action: PayloadAction<any>) => {
          state.loading = false;
          state.error =
            action.payload ||
...
}) => state.accountsReceivable.ar;
export const selectARInfo = (state: {
  accountsReceivable: AccountsReceivableState;
}) => state.accountsReceivable.info;
export const selectARLoading = (state: {
  accountsReceivable: AccountsReceivableState;
}) => state.accountsReceivable.loading;
export const selectARError = (state: {
  accountsReceivable: AccountsReceivableState;
}) => state.accountsReceivable.error;
