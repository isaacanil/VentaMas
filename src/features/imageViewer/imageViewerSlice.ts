...
export const selectImageViewerState = (state: ImageViewerRootState) =>
  state.imageViewer;
export const selectIsOpen = (state: ImageViewerRootState) =>
  state.imageViewer.isOpen;
export const selectImageViewerShow = (state: ImageViewerRootState) =>
  state.imageViewer.isOpen;
export const selectImages = (state: ImageViewerRootState) =>
  state.imageViewer.images;
export const selectCurrentIndex = (state: ImageViewerRootState) =>
  state.imageViewer.currentIndex;
