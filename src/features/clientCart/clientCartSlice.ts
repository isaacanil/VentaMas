...
export const selectClientWithAuth =
  (client: Client) => (dispatch: any, getState: any) => {
...
//selectors
export const selectClient = (state: ClientCartRootState) =>
  state.clientCart.client;
export const selectClientMode = (state: ClientCartRootState) =>
  state.clientCart.mode;
export const selectLabelClientMode = (state: ClientCartRootState) =>
  state.clientCart.labelClientMode;
export const selectIsOpen = (state: ClientCartRootState) =>
  state.clientCart.isOpen;
export const selectClientSearchTerm = (state: ClientCartRootState) =>
  state.clientCart.searchTerm;
