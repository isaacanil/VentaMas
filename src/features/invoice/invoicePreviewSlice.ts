...
export const selectInvoiceData = (state: InvoicePreviewRootState) =>
  state.invoicePreview.data;
export const selectInvoicePreview = (state: InvoicePreviewRootState) =>
  state.invoicePreview;
export const selectIsModalOpen = (state: InvoicePreviewRootState) =>
  state.invoicePreview.isOpen;
