...
const productExpirySelectorSlice = createSlice({
  ...
  reducers: {
    ...
    setProductExpiryState: (
      state,
      action: PayloadAction<Partial<ProductExpirySelectorState>>,
    ) => {
      return {
        ...state,
        ...action.payload,
...
export const selectProduct = (state: any) =>
  state.productExpirySelector.product;
export const selectProductId = (state: any) =>
  state.productExpirySelector.productId;
export const selectModalOpen = (state: any) =>
  state.productExpirySelector.isOpen;
