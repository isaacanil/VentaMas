...
type UserNotificationConfirm = (() => void) | string | null;
...
interface UserNotificationState {
  currentDialog: {
    ...
    title: string;
    description: string;
    onConfirm: UserNotificationConfirm;
...
const UserNotificationSlice = createSlice({
  ...
  reducers: {
    setUserNotification: (
      ...
      action: PayloadAction<UserNotificationState['currentDialog']>,
    ) => {
...
export const selectCurrentUserNotification = (
  state: UserNotificationRootState,
