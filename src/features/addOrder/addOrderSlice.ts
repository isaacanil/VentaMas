...
const addOrderSlice = createSlice({
  ...
  reducers: {
    getOrderData: (
      state: AddOrderState,
      actions: PayloadAction<OrderState | null>,
    ) => {
    ...
    setOrder: (
      state: AddOrderState,
      actions: PayloadAction<Partial<OrderState>>,
    ) => {
    ...
    getInitialCost: (
      state: AddOrderState,
      actions: PayloadAction<{ initialCost: number }>,
    ) => {
    ...
    updateProduct: (
      state: AddOrderState,
      action: PayloadAction<{ value: Partial<ProductSelected> }>,
    ) => {
    ...
    deleteProductFromOrder: (
      state: AddOrderState,
      actions: PayloadAction<{ id?: string; key?: string }>,
    ) => {
...
export const selectProductSelected = (state: AddOrderRootState) =>
  state.addOrder.productSelected;
export const selectProducts = (state: AddOrderRootState) =>
  state.addOrder.order.replenishments;
...
export const selectTotalOrder = (state: AddOrderRootState) =>
  state.addOrder.order.total;
