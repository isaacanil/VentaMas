...
const basicRecalcActions = [
  ...
  cartSlice.actions.setDocumentCurrency,
  cartSlice.actions.setDocumentExchangeRate,
  cartSlice.actions.setDocumentRateOverride,
  cartSlice.actions.setCreditNotePayment,
  cartSlice.actions.clearCreditNotePayment,
