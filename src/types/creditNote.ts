import type { InvoiceClient, InvoiceData, InvoiceProduct } from '@/types/invoice';
...
export type CreditNoteCreateInput = Omit<
  CreditNoteRecord,
  'id' | 'numberID' | 'number' | 'ncf' | 'status' | 'createdAt' | 'createdBy' | 'updatedAt'
>;
...
export type CreditNoteInvoiceInput = Partial<InvoiceData> & Record<string, unknown>;
