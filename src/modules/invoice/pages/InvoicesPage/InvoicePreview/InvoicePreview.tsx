...
import type { InvoiceClient, InvoiceData, InvoicePaymentMethod, InvoiceProduct } from '@/types/invoice';
...
export const InvoicePreview = () => {
  ...
  const invoicePreviewSelected = useSelector(selectInvoicePreview) as InvoicePreviewState;
    ...
    isOpen && (
      ...
      >
        <Container>
          ...
          <Products products={products as InvoiceProduct[]} />
