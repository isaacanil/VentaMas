...
type AccountReceivableInfoCardProps = {
  accountsReceivable?: AccountsReceivableDoc[];
  client?: InvoiceClient | null;
  invoiceData?: InvoiceData | null;
};

const EMPTY_ACCOUNTS_RECEIVABLE: AccountsReceivableDoc[] = [];

export const AccountReceivableInfoCard = ({
  accountsReceivable = EMPTY_ACCOUNTS_RECEIVABLE,
  client,
  invoiceData = null,
}: AccountReceivableInfoCardProps) => {
