...
export const AccountReceivableItem = ({ ar, client }: AccountReceivableItemProps) => {
    const { payments } = useFbGetAccountReceivablePayments(ar.id) as { payments: ReceivablePayment[] };
