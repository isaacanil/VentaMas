...
import {
  Line,
  SubTitle,
} from '@/modules/invoice/components/Quotation/templates/Invoicing/InvoiceTemplate1/InvoiceTemplate1';
import {
  Paragraph,
  Spacing,
  Subtitle,
} from '@/modules/invoice/components/Quotation/templates/Invoicing/InvoiceTemplate1/Style';
