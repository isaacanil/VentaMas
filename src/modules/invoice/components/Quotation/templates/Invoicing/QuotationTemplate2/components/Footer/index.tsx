...
export default function Footer({ data }: FooterProps) {
  ...
  const totals = {
    subtotal: formatInvoicePrice(subtotalValue, data),
    discount: `-${formatInvoicePrice(totalsSnapshot.generalDiscount || 0, data)}`,
    tax: formatInvoicePrice(taxValue, data),
    delivery: formatInvoicePrice(deliveryValue, data),
    total: formatInvoicePrice(totalValue, data),
  };
