...
const PREVIEW_PRODUCT_REPEAT_COUNT = import.meta.env.DEV ? 30 : 1;
...
export const buildPreviewProducts = (
  ...
  if (PREVIEW_PRODUCT_REPEAT_COUNT <= 1) {
    return sourceProducts;
  }

  return Array.from({ length: PREVIEW_PRODUCT_REPEAT_COUNT }).flatMap(
    (_, duplicateIndex) =>
