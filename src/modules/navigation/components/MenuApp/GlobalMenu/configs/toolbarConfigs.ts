...
import { registerToolbar } from '@/modules/navigation/components/MenuApp/GlobalMenu/core/registerToolbar';

import type { ToolbarRegistryEntry } from '@/modules/navigation/components/MenuApp/GlobalMenu/types';
...
export const toolbarConfigs: ToolbarRegistryEntry[] = [
  ...
  registerToolbar({
    ...
    routes: accountReceivableRoutes,
    importFn: () =>
  ...
  registerToolbar({
    id: 'providers-toolbar',
    routes: CONTACT_TERM.SUPPLIERS,
    importFn: () => import('../Page/ProvidersToolbar'),
    exportName: 'ProvidersToolbar',
  }),
  registerToolbar({
