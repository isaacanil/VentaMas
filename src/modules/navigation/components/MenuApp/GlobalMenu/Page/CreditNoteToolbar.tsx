...
import { createProfessionalCreditNoteReportCallback } from '@/utils/export/excel/exportConfig';
...
export const CreditNoteToolbar = ({
  ...
  const handleExportButton = (type: string) => {
    ...
    switch (type) {
      case 'Resumen': {
        ...
        exportPromise = (exportToExcel as any)(
          transformedResumenCreditNotesData(),
          'Resumen de Notas de Crédito',
          `resumen_notas_credito_${currentDate}.xlsx`,
          resumenCallback,
        ).then(
          () => 'El reporte resumen de notas de crédito se ha generado correctamente',
        );
        break;
      }
      case 'Detailed': {
        ...
        exportPromise = (exportToExcel as any)(
          ...
          () => 'El reporte detallado de notas de crédito se ha generado correctamente',
        );
        break;
      }
      default:
