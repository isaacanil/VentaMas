...
export default function TaxReceiptForm({
  ...
  const [sequenceAnalysis, setSequenceAnalysis] = useState<SequenceAnalysisState>({
    status: 'idle',
    result: null,
    error: null,
  });
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      setIsSaving(true);
      const values = (await form.validateFields()) as TaxReceiptFormValues;
      ...
      const warningDecision =
        (await confirmSequenceWarnings(sequenceValidation)) as SequenceWarningDecision;
