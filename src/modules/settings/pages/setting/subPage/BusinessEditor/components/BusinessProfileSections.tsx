      ...
      <CardBody>
        ...
        <Form.Item
          ...
          label={
            <LabelWithInfo>
              Logo del negocio
              <Tooltip title={<><div>Recomendación: versión horizontal y ligera para correos y comprobantes.</div><div style={{ marginTop: 4 }}>Formatos aceptados: JPG/PNG. Tamaño máximo: 2MB.</div></>}>
                <InfoIcon />
              </Tooltip>
            </LabelWithInfo>
          }
