import { SettingOutlined, DeleteOutlined } from '@/constants/icons/antd';
import {
  CalendarOutlined,
  DollarOutlined,
  NumberOutlined,
...
const InfoValue = styled.span<{ $highlighted?: boolean }>`
  overflow: hidden;
