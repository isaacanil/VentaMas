...
export const PreorderConfirmation = ({
  ...
  const printToggleLabel = isUpdate ? 'Imprimir al actualizar' : 'Imprimir al completar';
    ...
    >
      <Space direction="vertical" size="middle" style={{ width: '100%', padding: '8px 0' }}>
        <Text style={{ fontSize: '16px', display: 'block' }}>
          {isUpdate ? '¿Deseas actualizar la preventa' : '¿Deseas completar la preventa'} 
          {' '}<strong>{preorderNumber}</strong> para el cliente <strong>{clientName}</strong>?
        </Text>
