...
type MarkAsReceivableButtonProps = {
...
export const MarkAsReceivableButton = ({
  ...
  const stopButtonPropagation = (event: ReactMouseEvent<HTMLElement>) => {
    event.preventDefault();
    event.stopPropagation();
  };

  function handleAddToReceivable(event?: ReactMouseEvent<HTMLElement>) {
    event?.preventDefault();
    event?.stopPropagation();
