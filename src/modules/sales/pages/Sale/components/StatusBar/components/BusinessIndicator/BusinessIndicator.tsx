...
import { ReturnToBusinessModal } from '@/modules/sales/pages/Sale/components/StatusBar/components/ReturnToBusinessModal/ReturnToBusinessModal';
...
export const BusinessIndicator = () => {
  ...
  const businessIndicator: BusinessIndicatorConfig = isTemporaryMode
    ? {
        text: 'VISITANDO',
        icon: faUsers,
        color: '#ff6b35',
  ...
  if (!hasDeveloperAccess(user)) return null;
  return (
    <>
      <Tooltip
        title={
