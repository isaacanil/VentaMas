...
const ListComponent = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ ...props }, ref) => <GridList ref={ref} {...props} />,
);
ListComponent.displayName = 'ProductListGrid';

const ItemComponent = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
...
export const ProductList = ({
  ...
  const renderProduct = (_: number, product?: ProductRecord) => {
