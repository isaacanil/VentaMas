/* utils/stockTheme.js */
export type ProductStockThemeProps = {
...
export const getProductTheme = (props: ProductStockThemeProps) => {
...
export const getContainerOutline = (props: ProductStockThemeProps) => {
  const isSelected = props.isSelected || props.$isSelected;
  return isSelected ? getProductTheme(props).outlineSelected : 'none';
};

export const getAmountColor = (props: ProductStockThemeProps) =>
  getProductTheme(props).amountColor;
export const getPriceColor = (props: ProductStockThemeProps) =>
  getProductTheme(props).textColor;
