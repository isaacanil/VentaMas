            ...
            >
              ...
              {invoiceCounterUpdatedAt && (
                <Text type="secondary">
                  ...
                  {formatDateTime(invoiceCounterUpdatedAt)}
                </Text>
              )}
              {shouldWarnInvoiceNumber && (
                <Alert
              ...
              <Paragraph type="secondary" style={{ marginBottom: 0 }}>
                Usa estas acciones para corregir el contador{' '}
                <code>counters/lastInvoiceId</code> cuando el consecutivo quede
                desfasado del número real de la factura.
              </Paragraph>
              <Space wrap align="center">
                <Button
                  onClick={refreshInvoiceCounter}
                  loading={loadingInvoiceCounter}
                >
                  Refrescar contador
                </Button>
                <Button
                ...
                <Space align="center">
                  ...
                  <Button
                    ...
                    loading={updatingInvoiceCounter}
                    disabled={
                      customCounterValue === null ||
                      customCounterValue === undefined
                    }
                  >
                    Guardar contador
                  </Button>
              ...
              <Paragraph type="secondary" style={{ marginBottom: 0 }}>
                También puedes asignar manualmente el número correcto en Invoice
                V2 e invoices y luego sincronizar el contador en un solo paso.
              </Paragraph>
                  ...
                  <List.Item key={item.id}>
                    ...
                    >
                      <Space>
                        ...
                        {item.state && (
                          <Tag
                            color={item.state === 'open' ? 'green' : 'default'}
                          >
                            {item.state}
                          </Tag>
                        )}
                    ...
                    return (
                      <Checkbox key={key} value={key} disabled={isDisabled}>
                        <Space orientation="vertical" size={0}>
                          ...
                          {isDisabled && (
                            <Text type="secondary">
                              Ya está registrada en un cuadre.
                            </Text>
                          )}
                        </Space>
                      </Checkbox>
