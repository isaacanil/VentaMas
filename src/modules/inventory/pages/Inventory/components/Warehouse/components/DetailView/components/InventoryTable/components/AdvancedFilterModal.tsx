...
import type { DraftBatchOption, FilterDraft, ProductOption } from '@/modules/inventory/pages/Inventory/components/Warehouse/components/DetailView/components/InventoryTable/types';
