...
import { formatDateTime } from '@/modules/inventory/utils/dates';
import {
  formatBatchLabel,
...
const BatchViewModal = ({
  ...
  const batchLabel = formatBatchLabel(batchData?.numberId, {
    prefix: 'Lote #',
    noBatchLabel: 'Lote #-',
  });
  const quantityLabel = formatInventoryQuantity(batchData?.quantity);
  const initialQuantityLabel = formatInventoryQuantity(
