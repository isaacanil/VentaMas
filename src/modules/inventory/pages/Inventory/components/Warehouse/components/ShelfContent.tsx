...
import { ProductStockForm } from '@/modules/inventory/pages/Inventory/components/Warehouse/forms/ProductStockForm/ProductStockForm';
...
export default function ShelfContent() {
  ...
  const location = useMemo<InventoryStockItem['location'] | null>(
    () =>
      shelfId
        ? {
  ...
  const handleDeleteRowShelf = async (row: RowShelfRecord) => {
