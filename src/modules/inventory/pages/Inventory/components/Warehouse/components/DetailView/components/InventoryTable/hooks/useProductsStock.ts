...
import type { InventoryTableProps, ProductStockLike } from '@/modules/inventory/pages/Inventory/components/Warehouse/components/DetailView/components/InventoryTable/types';
