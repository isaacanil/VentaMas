...
type InventoryLocationSelectorProps = {
  value?: string[];
...
const EMPTY_LOCATION_VALUES: string[] = [];
const EMPTY_LOCATION_OPTIONS: InventoryLocationOption[] = [];
...
export const InventoryLocationSelector = ({
  value = EMPTY_LOCATION_VALUES,
  options = EMPTY_LOCATION_OPTIONS,
  loading = false,
  ...
  const selectedOptions = useMemo<InventoryLocationOption[]>(
    () =>
      value
