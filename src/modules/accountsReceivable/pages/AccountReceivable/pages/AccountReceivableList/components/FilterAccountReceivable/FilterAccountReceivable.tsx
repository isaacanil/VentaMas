...
const DEFAULT_PAYMENT_STATUS: AccountsReceivablePaymentStatus = 'all';
...
const SORT_OPTIONS: Array<{ value: AccountsReceivableSortCriteria; label: string }> = [
...
const STATUS_OPTIONS: Array<{ value: AccountsReceivableStatusFilter; label: string }> = [
...
const CLIENT_TYPE_OPTIONS: Array<{ value: AccountsReceivableClientType; label: string }> = [
