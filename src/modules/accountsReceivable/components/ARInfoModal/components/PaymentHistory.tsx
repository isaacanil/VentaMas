...
import { AccountsReceivablePaymentReceipt } from '@/modules/checkout/public';
import type {
...
import { HighlightCard } from './PaymentHistory.styles';
import { TableCard } from './TableCard.styles';
