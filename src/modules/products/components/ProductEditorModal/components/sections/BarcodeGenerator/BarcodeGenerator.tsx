...
import useProductRealtimeListener from '@/modules/products/hooks/useProductRealtimeListener';
import useBarcodeSettings from '@/modules/products/hooks/useBarcodeSettings';
import {
  generateGTIN13RD,
