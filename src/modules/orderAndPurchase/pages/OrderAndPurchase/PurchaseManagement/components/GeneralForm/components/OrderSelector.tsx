...
const OrderSelector = ({ orders = [], orderLoading }: OrderSelectorProps) => {
        ...
        <div style={{ width: '100%', position: 'relative' }}>
          <Form.Item
            ...
            help={
              selectedOrder
                ? `${formatDate(
                    selectedOrder?.dates?.createdAt ?? selectedOrder?.createdAt ?? 0,
                  )} | (${formatPrice(
              ...
              filteredOrders.map((order) => (
                ...
                >
                  ...
                  <div className="order-date">
                    {formatDate(order.dates?.createdAt ?? order.createdAt ?? '')}
                  </div>
