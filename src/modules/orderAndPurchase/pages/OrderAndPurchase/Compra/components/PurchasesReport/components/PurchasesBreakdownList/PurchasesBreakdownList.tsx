...
type PurchasesBreakdownListItem = {
  key: string;
  label: string;
  value: string;
  detail: string;
...
type PurchasesBreakdownListProps = {
  title: string;
  subtitle: string;
  items: PurchasesBreakdownListItem[];
  emptyMessage: string;
};

export const PurchasesBreakdownList = ({
  title,
  subtitle,
  items,
  emptyMessage,
}: PurchasesBreakdownListProps) => (
  <Section>
    <Header>
      <Title>{title}</Title>
