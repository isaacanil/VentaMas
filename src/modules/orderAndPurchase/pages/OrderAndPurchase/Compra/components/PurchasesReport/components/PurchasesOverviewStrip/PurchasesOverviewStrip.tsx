...
type PurchasesOverviewStripProps = {
  spend: number;
  paid: number;
  pending: number;
...
export const PurchasesOverviewStrip = ({
  spend,
  paid,
  pending,
  averageTicket,
  purchases,
  providers,
}: PurchasesOverviewStripProps) => {
  const metrics: MetricItem[] = [
    {
      label: 'Comprado',
      value: formatPrice(spend),
      detail: 'Monto total del rango visible',
    },
    {
      label: 'Pagado',
      value: formatPrice(paid),
      detail: 'Abonos aplicados a estas compras',
    },
    {
      label: 'Pendiente',
      value: formatPrice(pending),
      detail: 'Balance todavia abierto',
    },
    {
      label: 'Ticket promedio',
      value: formatPrice(averageTicket),
      detail: 'Promedio por compra',
    },
    {
      label: 'Compras',
