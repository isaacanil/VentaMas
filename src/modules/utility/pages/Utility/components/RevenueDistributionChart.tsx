...
type PercentageTone = 'success' | 'danger' | 'secondary';
const EMPTY_DISTRIBUTION_DETAILS: UtilityDistributionDetail[] = [];

const getPercentageColor = (value: number): PercentageTone => {
...
interface RevenueDistributionChartProps {
  loading: boolean;
  chartData: ChartData<'doughnut', number[], string> | null;
...
export const RevenueDistributionChart = ({
  ...
  chartData,
  chartOptions,
  distributionDetails = EMPTY_DISTRIBUTION_DETAILS,
  formatCurrency,
  formatPercentage,
  totalSales,
}: RevenueDistributionChartProps): JSX.Element => {
    ...
    <ChartCard>
      ...
      <ChartBody>
        {loading ? (
          ...
          <PieWrapper>
            <DoughnutContainer>
              <LazyDoughnut data={chartData} options={chartOptions} />
            </DoughnutContainer>
            <DistributionLegend>
