...
import type { UtilityDailyMetric, UtilityTransactionRow, UtilityTrend } from '@/modules/utility/pages/Utility/types';
...
const buildWorksheet = (sheet: Worksheet, rows: UtilityTransactionRow[]): void => {
  sheet.columns = [
