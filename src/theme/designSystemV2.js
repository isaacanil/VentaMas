...
export const designSystemV2 = Object.freeze({
    ...
    typography: {
        ...
        label: { fontSize: '0.75rem', lineHeight: '1rem', fontWeight: 600, letterSpacing: '0.04em' },
        overline: { fontSize: '0.7rem', lineHeight: '1rem', fontWeight: 600, letterSpacing: '0.08em' },
