...
export interface InputV4Props extends Omit<
...
const InputWrapper = styled.div.attrs(() => ({
  ...
  gap: 4px;
  color: rgb(51 51 51);
  border-radius: ${(props: InputWrapperProps) =>
    props.$hasButtons ? '4px 0 0 4px' : '4px'};
  ...
  height: 2em;
  width: 100%;
  max-width: ${(props: InputWrapperProps) =>
    props.$search ? '280px' : 'none'};
  position: relative;
