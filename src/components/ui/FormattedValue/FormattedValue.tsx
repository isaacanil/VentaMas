...
const formatDateValue = (value: number | string | null | undefined): string => {
  ...
  return DateTime.fromMillis(Number(timestamp)).toLocaleString(DateTime.DATE_MED);
};
...
const noWrapStyle = (props: TextProps) => (props.$noWrap ? "white-space: nowrap;" : "");
const boldStyle = (props: TextProps) => (props.$bold ? "font-weight: bold;" : "");
