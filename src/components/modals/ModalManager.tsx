...
const RowShelfForm = lazy(() =>
  import(
    '@/modules/inventory/pages/Inventory/components/Warehouse/forms/RowShelfForm/RowShelfForm'
  ),
);
const SegmentForm = lazy(() =>
  import(
    '@/modules/inventory/pages/Inventory/components/Warehouse/forms/SegmentForm/SegmentForm'
  ),
);
...
const NoteModal = lazy(() =>
  import('@/components/ui/NoteModal/NoteModal'),
);
...
const DeleteProductStockModal = lazy(() =>
  import(
    '@/modules/inventory/pages/Inventory/components/Warehouse/components/DeleteProductStock/DeleteProductStockModal'
  ).then((module) => ({ default: module.DeleteProductStockModal })),
);
const ShelfForm = lazy(() =>
  import(
    '@/modules/inventory/pages/Inventory/components/Warehouse/forms/ShelfForm/ShelfForm'
  ).then((module) => ({ default: module.ShelfForm })),
);
const WarehouseForm = lazy(() =>
  import(
    '@/modules/inventory/pages/Inventory/components/Warehouse/forms/WarehouseForm/WarehouseForm'
...
const TestModeIndicator = lazy(() =>
  import('@/components/ui/Notification/TestModeIndicator').then(
...
const DeveloperModal = lazy(() =>
  import('./DeveloperModal/DeveloperModal').then(
...
const ClientFormAnt = lazy(() =>
  import(
    '@/modules/contacts/pages/Contact/Client/components/ClientForm/ClientFormAnt'
  ).then((module) => ({ default: module.default })),
);
const ProviderForm = lazy(() =>
  import(
    '@/modules/contacts/pages/Contact/Provider/components/CreateContact/ProviderForm'
  ).then((module) => ({ default: module.ProviderForm })),
);
const ProductStockForm = lazy(() =>
  import(
    '@/modules/inventory/pages/Inventory/components/Warehouse/forms/ProductStockForm/ProductStockForm'
...
const EvidenceUploadDrawer = lazy(() =>
  import(
    '@/modules/orderAndPurchase/pages/OrderAndPurchase/PurchaseManagement/components/EvidenceUploadDrawer/EvidenceUploadDrawer'
  ).then((module) => ({ default: module.default })),
);
