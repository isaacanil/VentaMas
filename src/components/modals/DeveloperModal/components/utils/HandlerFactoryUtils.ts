...
export class HandlerFactoryUtils {
   ...
   */
  static validateHandlerConfig(config: any) {
   ...
   */
  static createStandardHandler(config: any) {
   ...
   */
  static createCrudHandlers(config: any) {
   ...
   */
  static createListHandler(config: any) {
    const {
      context,
      loadFunction,
      formatter,
   ...
   */
  static createSelectionHandler(config: any) {
   ...
   */
  static createHelpHandler(config: any) {
    const {
      context,
      commands = [],
      handlerName = 'Handler',
   ...
   */
  static createNavigationHandler(config: any) {
   ...
   */
  static createToggleHandler(config: any) {
