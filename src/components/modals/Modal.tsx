...
import { MotionWrapper } from '@/components/common/base/animation/MotionWrapper';

type ModalWidth = 'small' | 'medium' | 'large' | 'extra-large';
...
`;
const Container = styled(motion.div)<{ $width?: ModalWidth }>`
  width: 100vw;
  max-width: 720px;
  height: 98vh;
  max-height: 1000px;
