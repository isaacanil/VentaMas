import { CalendarOutlined, ClockCircleOutlined } from '@/constants/icons/antd';
import { Tooltip } from 'antd';
import React from 'react';

import { SectionTitle, TableCard, HighlightCard } from '@/components/modals/ARInfoModal/styles';
