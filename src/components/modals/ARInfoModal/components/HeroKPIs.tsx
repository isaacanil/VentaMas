...
import { HeroKPIContainer, KPICard } from '@/components/modals/ARInfoModal/styles';
import { formatCurrency, getNextPaymentInfo, getDaysLate } from '@/components/modals/ARInfoModal/utils';
...
const HeroKPIs = ({ data }: HeroKPIsProps) => {
    // Calcular total de factura con fallback robusto
    const totalInvoice = toNumber(
    ...
    const totalReceivable =
        toNumber(data?.ar?.totalReceivable) || totalInvoice || 0;
