 ...
 */
const FiscalReceiptsList: React.FC<FiscalReceiptsListProps> = ({ receipts = [], showAll = false }) => {
  ...
  const getStatusText = (alertLevel: AlertLevel, remainingNumbers: number): string => {
    switch (alertLevel) {
      case 'critical':
