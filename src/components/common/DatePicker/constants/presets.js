...
export const createDefaultPresets = (mode = 'single') => [
    ...
    },
    {
        label: 'Año pasado',
        value: mode === 'range'
            ? [dayjs().subtract(1, 'year').startOf('year'), dayjs().subtract(1, 'year').endOf('year')]
    ...
    // Trimestres actuales
    {
        ...
        value: mode === 'range'
            ? [dayjs().startOf('year'), dayjs().startOf('year').add(2, 'month').endOf('month')]
            : dayjs().startOf('year'),
        group: 'Trimestres'
    },
    {
        ...
        value: mode === 'range'
            ? [dayjs().startOf('year').add(3, 'month'), dayjs().startOf('year').add(5, 'month').endOf('month')]
    ...
    },
    {
        ...
        value: mode === 'range'
            ? [dayjs().startOf('year').add(6, 'month'), dayjs().startOf('year').add(8, 'month').endOf('month')]
    ...
    },
    {
        ...
        value: mode === 'range'
            ? [dayjs().startOf('year').add(9, 'month'), dayjs().startOf('year').add(11, 'month').endOf('month')]
