...
export type ModalWidth = 'small' | 'medium' | 'large' | 'extra-large';

export type LegacyMotionModalProps = {
  children: ReactNode;
  nameRef?: ReactNode;
...
export const LegacyMotionModal = ({
  children,
  nameRef,
  handleSubmit,
  close,
...
export default LegacyMotionModal;
...
`;
const Container = styled(m.div)<{ $width?: ModalWidth }>`
  width: 100vw;
  max-width: 720px;
  height: 98vh;
  max-height: 1000px;
