...
import { formatDate, formatInputDate, normalizeExpirationValue } from '@/utils/inventory/dates';
import { getEffectiveCount, getPersistedCount } from '@/utils/inventory/counts';
import { formatNumber } from '@/utils/inventory/format';
import type { LocationNamesMap, ResolvingMap, TimestampLike } from '@/utils/inventory/types';
...
interface DiffProps { $value: number }
