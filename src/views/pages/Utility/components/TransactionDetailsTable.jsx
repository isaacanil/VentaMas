...
export const TransactionDetailsTable = ({ dailyMetrics, formatCurrency, pageSize = 7 }) => {
    const rows = useMemo(() => buildTransactionRows(dailyMetrics), [dailyMetrics]);
    ...
    return (
        <TableCard>
            ...
            {paginationVisible && (
                <Pagination>
                    <PaginationButton type="button" onClick={handlePrev} disabled={currentPage === 0}>
                        Anterior
                    </PaginationButton>
                    <PaginationPages>
