    ...
    return (
        <Container>
            ...
            >
                ...
                <Description>
                    Impulsa tu facturación con una plataforma en la nube ágil, segura y lista para usar desde el primer día.
                </Description>
            </div>
        </Container>
    )
...
const BrandBadge = styled.div`
    ...
    padding:
        clamp(0.4rem, 0.4rem, 0.4rem)
        clamp(1.5rem, 1.5rem, 1.5rem)
        clamp(0.4rem, 0.4rem, 0.4rem)
        clamp(0.7rem, 0.7rem, 0.7rem);
    border-radius: 999px;
