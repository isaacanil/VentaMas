...
import { QuotationTemplate2 } from '@/views/component/Quotation/templates/Invoicing/QuotationTemplate2/QuotationTemplate2';
...
export const Quotation = React.forwardRef(
