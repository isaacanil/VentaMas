...
export const getPaymentMethodMeta = (methodKey?: string | null, fallbackLabel?: string): PaymentMethodMeta => {
    if (!methodKey) {
        return fallbackLabel ? { ...defaultMeta, label: fallbackLabel } : defaultMeta
    }
