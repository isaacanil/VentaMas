...
const ErrorState = () => {
  return (
    <WidgetContainer alertColor="#ef4444" hasIssues={true}>
      <WidgetHeader>
        <HeaderInfo>
          ...
          <HeaderContent>
            <WidgetTitle>Error</WidgetTitle>
            <WidgetMessage>No se pudieron cargar los datos</WidgetMessage>
          </HeaderContent>
        </HeaderInfo>
      </WidgetHeader>
    </WidgetContainer>
