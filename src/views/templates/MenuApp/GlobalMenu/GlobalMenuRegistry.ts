 ...
 */
const toolbarEntries: ToolbarEntryWithMatchers[] = toolbarRegistry.map((entry) => ({
  ...entry,
 ...
 */
export const findToolbarEntry = (pathname: string): ToolbarEntryWithMatchers | undefined =>
  findEntry(pathname, toolbarEntries)

export default toolbarRegistry

// Re-export types for convenience
export type { ToolbarSide, ToolbarComponentProps, ToolbarComponent, ToolbarRegistryEntry } from './types/types'
