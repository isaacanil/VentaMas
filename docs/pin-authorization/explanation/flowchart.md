...
El flujo de autorizaciones con PIN habilita configuraciones centralizadas, generación/gestión de PINs por módulo y validación en tiempo real cuando se ejecutan acciones sensibles (facturas, cuentas por cobrar, etc.).

## 🎯 Objetivos

- Documentar los tres flujos principales: configuración de PIN, autorización inmediata y solicitud/aprobación de facturas.
- Mostrar cómo se conectan los componentes de UI con Hooks y funciones Firebase.
- Facilitar onboarding visual mediante diagramas ASCII del recorrido completo.
...
- 👍 Mejora la seguridad de operaciones sensibles sin bloquear el flujo: admins generan PINs y los usuarios operan desde cualquier componente.
- 👍 Los distintos flujos (configuración, uso inmediato, aprobación) están desacoplados y comparten hooks y servicios.
- ⚠️ Depende de una entrega manual del PIN (solo se muestra una vez); requiere protocolos claros de comunicación.
- ⚠️ Los tiempos de expiración y módulos habilitados deben mantenerse coordinados con el estado real de autorizaciones.

## 🔜 Seguimiento / Próximos pasos

- [ ] Agregar indicadores visuales de expiración dentro del AuthorizationsManager.
- [ ] Documentar un proceso de recuperación de PIN para usuarios que pierdan su código.
- [ ] Automatizar alertas cuando falte cobertura de PIN (usuarios críticos sin PIN activo).
