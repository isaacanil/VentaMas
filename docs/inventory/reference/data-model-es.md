...
- Esquema activo desde 2024; nuevos campos se agregan como opcionales para no romper historiales.
- `productsStock` y `movements` comparten auditoría para mantener consistencia.
- Las sesiones de inventario (`inventorySessions`) son compatibles con ajustes masivos y cron jobs.
