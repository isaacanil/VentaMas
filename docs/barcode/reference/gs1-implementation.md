...
- **Dimensiones clave**: X-dimension 0.33 mm, altura mínima 22.85 mm, quiet zones ≥10X, DPI 203.
- **Tipos soportados**: UPC-A, EAN-13, EAN-8, GTIN-14, Code-128 (con límites de longitud validados).
- **Configuración de etiquetas**: tamaños estándar (2.25"x1.25"), compacta (2"x1") y grande (3"x1").
- **Configuración Firestore**: `businesses/{bid}/settings/barcode` mantiene prefijos y estructuras por negocio.
...
- Optimizado para impresoras Zebra/DYMO/Brother con 203 DPI.
- Cumple GS1 República Dominicana y estándares internacionales (Ean/UPC).
- Validado en navegadores modernos con soporte para CSS `@page`.
