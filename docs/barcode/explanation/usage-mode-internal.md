...
El modo de uso interno habilita la generación de GTIN-13 masivos sin depender de membresías GS1. La plataforma ofrece estructuras alternativas que reasignan dígitos al identificador de producto para alcanzar hasta 999 millones de referencias.

## 🎯 Objetivos

- Maximizar la capacidad de códigos cuando el negocio no requiere interoperar con GS1.
- Proveer plantillas predefinidas (sin categorías, con 2 o 3 dígitos) para distintos escenarios.
- Integrar ambos modos (estándar e interno) en la misma interfaz para alternar rápidamente.
...
- 👍 Permite escalar catálogos internos gigantes sin pagar licencias GS1.
- 👍 Flexibilidad para reorganizar dígitos según rubros o líneas de producto.
- ⚠️ Los códigos internos no pueden circular fuera del ecosistema del negocio; requieren base de datos propia.
- ⚠️ Se necesita una conversión clara cuando un SKU interno pase a canal con GS1 oficial.

## 🔜 Seguimiento / Próximos pasos

- [ ] Documentar cómo migrar un producto de modo interno a estándar sin perder historial.
- [ ] Agregar validaciones de consistencia cuando se mezclan categorías internas y prefijos GS1.
- [ ] Incorporar métricas de uso por modo para priorizar mejoras en la UI.
