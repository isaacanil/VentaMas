...
Imprime etiquetas GS1 (UPC/EAN) compatibles con Zebra, DYMO y Brother usando CSS `@page` ajustado, validaciones y layouts estándar.

## Lista de verificación

- [ ] Etiquetas compatibles (2.25"x1.25" u otras aprobadas).
- [ ] Impresora calibrada (Zebra/DYMO/Brother o laser con Avery 5160).
- [ ] Código generado previamente (usar `generateGTIN13` o importado).
- [ ] Navegador con soporte `@media print`.
...
- Imprime códigos UPC-A/EAN-13 y mídeles para confirmar quiet zones y altura mínima.
- Escanea etiquetas en un POS real o escáner GS1 y valida tasa ≥99%.
- Prueba al menos una corrida masiva (100 etiquetas) para verificar alineación y breaks.
- Confirma que React-Barcode genere check digits correctos comparándolos contra herramientas GS1.
