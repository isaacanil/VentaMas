...
- Membresia y permisos: `members/{uid}`, `userPermissions/{uid}`. Evidencia: `functions/src/app/versions/v2/auth/controllers/businessInvites.controller.js:285-330`, `src/firebase/permissions/dynamicPermissions.repository.ts`.
