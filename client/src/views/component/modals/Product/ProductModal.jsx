...
export const ProductModal = ({title, btnSubmitName, closeModal, handleSubmit, isOpen}) => {
  ...
  // console.log(productImage)
   ...
   return (
      <Fragment>
         ...
         <Modal nameRef={title} btnSubmitName={btnSubmitName} close={closeModal} handleSubmit={handleSubmit}>
