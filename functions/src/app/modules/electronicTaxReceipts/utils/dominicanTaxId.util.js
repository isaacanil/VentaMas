...
const RNC_CHECKSUM_WEIGHTS = [7, 9, 8, 6, 5, 4, 3, 2];
const CEDULA_CHECKSUM_WEIGHTS = [1, 2, 1, 2, 1, 2, 1, 2, 1, 2];
...
export const normalizeDominicanTaxIdDigits = (value) => {
...
const calculateRncCheckDigit = (digits) => {
...
const hasValidCheckDigit = (digits, kind) => {
  const expected =
    kind === 'rnc'
...
export const validateDominicanTaxId = (value) => {
...
export const normalizeValidDominicanTaxId = (value) => {
